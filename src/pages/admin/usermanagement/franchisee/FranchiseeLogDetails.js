...
const FranchiseeLogDetails = () => {
  ...
  return (
    <div>
      ...
      {!isLoading && userLogSession?.data?.length === 0 && (
        <p className="text-center">No login details for Franchisees</p>
      )}
    </div>
  );
};

export default FranchiseeLogDetails;
